...
food = { x:6, y:7} //Collection of single object

//FUNCTION - Game Function run entire app
function main(ctime){
    window.requestAnimationFrame(main); //game become loop
    // console.log(ctime)
...
//EVENT - Key press for game
window.addEventListener('keydown', (e) => {
    inputDir = { x:0, y:1 };
    moveSound.play();
    //Switchcase for Key movement
    switch(e.key){
        case "ArrowUp":
            // console.log("ArrowUp");
            inputDir.x = 0;
